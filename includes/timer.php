<section class="section section-lg bg-gradient-default" id="timer">
    <div class="row justify-content-center text-center">
        <div class="col-lg-8">
            <h2 class="display-1">Wait for <strong>Shells</strong> </h2>
    ...
    <div class="container pt-lg pb-300">
        <div class="row">
            <div class="col-md-3">
                <div id="days" class="time text-center">22 <span> Days</span></div>
            </div>
            <div class="col-md-3">
                <div id="hours" class="time text-center">22 <span> Days</span></div>
            </div>
            <div class="col-md-3">
                <div id="minutes" class="time text-center">22 <span> Days</span></div>
            </div>
            <div class="col-md-3">
                <div id="seconds" class="time text-center">22 <span> Days</span></div>
            </div>
        </div>
