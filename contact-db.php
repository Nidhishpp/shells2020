...
if (isset($_POST['email'])) {
    ...
    if (filter_input(INPUT_POST, "email", FILTER_VALIDATE_EMAIL) === false) {
        ...
        $mail = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml"><head>
                        ...
                        <tbody><tr>
                        <td style="background-color:#ffffff; padding:50px 0px 30px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="#ffffff"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 24px; color: #000000">We have a new Query.</span></div><div></div></div></td>
                        </tr>
                        ...
                        <tbody><tr>
                        <td style="background-color:#ffffff; padding:30px 50px 30px 50px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="#ffffff"><div><div style="font-family: inherit; text-align: left"><span style="color: #474646">' . $_POST['name'] . ' tried to contact you.</span></div>
                        <div style="font-family: inherit; text-align: left"><span style="color: #474646">Email: ' . $_POST['email'] . '</span></div>
                        <div style="font-family: inherit; text-align: left"><br></div>
                        <div style="font-family: inherit; text-align: left"><span style="color: #474646">' . $_POST['message'] . '</span></div>
        ...
        $email->addContent("text/plain", "We Have a new query");
        $email->addContent(
            "text/html",
            $mail
        );
