<footer class="footer has-cards">
    <div class="container">
        <div class="row row-grid align-items-center my-md">
            <div class="col-lg-4">
                <img src="assets/img/logo/shells-logo.png" class="footer-logo">
                <h3 class="text-primary font-weight-light mb-2">SHELLS 2020</h3>
                </h3>
                <!-- <h4 class="mb-0 font-weight-light">Let's get in touch on any of these platforms.</h4> -->
            </div>
            <div class="col-lg-4">
                <h5 class="lead">Links</h5>
            ...
            <div class="col-lg-4 text-lg-center btn-wrapper">
                ...
                <a target="_blank" href="https://www.facebook.com/ShellsITfest"
                    class="btn btn-neutral btn-icon-only btn-facebook btn-round btn-lg" data-toggle="tooltip"
                    data-original-title="Like us">
                    <i class="fa fa-facebook-square"></i>
                </a>
                <a target="_blank" href="https://www.instagram.com/shells__2020/"
        ...
        <div class="row align-items-center justify-content-md-between">
            <div class="col-md-6">
                <div class="copyright">
                    &copy; 2020 <a href="https://kristujayanti.edu.in/" target="_blank">Kristu Jayanti College</a>.
                </div>
            </div>
            <div class="col-md-6">
